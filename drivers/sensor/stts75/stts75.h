...
#ifndef ZEPHYR_DRIVERS_SENSOR_STTS75_STTS75_H_
#define ZEPHYR_DRIVERS_SENSOR_STTS75_STTS75_H_
...
// #define ISL29035_ACTIVE_OPMODE_BITS		(ISL29035_ACTIVE_OPMODE << ISL29035_OPMODE_SHIFT)
...
// #define ISL29035_LUX_RANGE_BITS			(ISL29035_LUX_RANGE_IDX << ISL29035_LUX_RANGE_SHIFT)
...
// #define ISL29035_ADC_RES_BITS			(ISL29035_ADC_RES_IDX << ISL29035_ADC_RES_SHIFT)
...
#if defined(CONFIG_STTS75_TRIGGER_OWN_THREAD)
	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_STTS75_THREAD_STACK_SIZE);
	struct k_thread thread;
	struct k_sem gpio_sem;
#elif defined(CONFIG_STTS75_TRIGGER_GLOBAL_THREAD)
	struct k_work work;
#endif

#endif /* CONFIG_STTS75_TRIGGER */
};

struct stts75_config {
...
// int stts75_attr_set(const struct device *dev,
// 		      enum sensor_channel chan,
// 		      enum sensor_attribute attr,
// 		      const struct sensor_value *val);

// int stts75_trigger_set(const struct device *dev,
// 			 const struct sensor_trigger *trig,
// 			 sensor_trigger_handler_t handler);

// int stts75_init_interrupt(const struct device *dev);
#endif

#endif /* ZEPHYR_DRIVERS_SENSOR_STTS75_STTS75_H_ */
